...
public class TextSequenceDecls {
     ...
     * why there is not a <CODE>set</CODE> method for the textSequenceDecl property.
     * 
     * <p>
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link TextSequenceDecl }
     * 
     * 
     */
    public List<TextSequenceDecl> getTextSequenceDecl() {
        if (this.textSequenceDecl == null) {
            this.textSequenceDecl = new ArrayList<TextSequenceDecl>();
        }
