...
public class TextDdeConnectionDecls {
     ...
     * why there is not a <CODE>set</CODE> method for the textDdeConnectionDecl property.
     * 
     * <p>
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link TextDdeConnectionDecl }
     * 
     * 
     */
    public List<TextDdeConnectionDecl> getTextDdeConnectionDecl() {
        if (this.textDdeConnectionDecl == null) {
            this.textDdeConnectionDecl = new ArrayList<TextDdeConnectionDecl>();
        }
