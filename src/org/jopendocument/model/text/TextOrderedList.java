...
public class TextOrderedList {
    ...
    public String getTextContinueNumbering() {
        if (this.textContinueNumbering == null) {
            return "false";
        } else {
            return this.textContinueNumbering;
        }
    }
     ...
     * 
     */
    public void setTextContinueNumbering(final String value) {
        this.textContinueNumbering = value;
    }
