...
public class TextSortKey {
    ...
    public String getTextSortAscending() {
        if (this.textSortAscending == null) {
            return "true";
        } else {
     ...
     * 
     */
    public void setTextKey(final String value) {
        this.textKey = value;
    }
     ...
     * 
     */
    public void setTextSortAscending(final String value) {
        this.textSortAscending = value;
    }
