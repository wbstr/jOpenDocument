...
public class StylePageLayout {
    ...
    public final StylePageLayout reset() {
        this.setPageLayoutProperties(null);
        return this;
    }
    ...
    public void setPageLayoutProperties(final StylePageLayoutProperties props) {
        if (props == null) {
            this.pageLayoutProperties = new StylePageLayoutProperties().reset();
        } else {
            this.pageLayoutProperties = props;
        }
    }

    public void setStyleName(final String n) {
        this.styleName = n;
