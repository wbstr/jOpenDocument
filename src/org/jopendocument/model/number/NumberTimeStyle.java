...
public class NumberTimeStyle {
    ...
    /**
     * Gets the value of the numberTextOrNumberHoursOrNumberAmPmOrNumberMinutesOrNumberSeconds
     * property.
     * 
     * <p>
     ...
     * numberTextOrNumberHoursOrNumberAmPmOrNumberMinutesOrNumberSeconds property.
     * 
     * <p>
     ...
     * {@link NumberHours } {@link NumberAmPm } {@link NumberMinutes } {@link NumberSeconds }
     * 
     * 
     */
    public List<Object> getNumberTextOrNumberHoursOrNumberAmPmOrNumberMinutesOrNumberSeconds() {
        if (this.numberTextOrNumberHoursOrNumberAmPmOrNumberMinutesOrNumberSeconds == null) {
            this.numberTextOrNumberHoursOrNumberAmPmOrNumberMinutesOrNumberSeconds = new ArrayList<Object>();
        }
    ...
    public String getNumberTruncateOnOverflow() {
        if (this.numberTruncateOnOverflow == null) {
            return "true";
        } else {
            return this.numberTruncateOnOverflow;
        }
    }
     ...
     * 
     */
    public void setNumberTruncateOnOverflow(final String value) {
        this.numberTruncateOnOverflow = value;
    }
