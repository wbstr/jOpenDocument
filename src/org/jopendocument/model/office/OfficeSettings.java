...
public class OfficeSettings {
     ...
     * why there is not a <CODE>set</CODE> method for the configConfigItemSet property.
     * 
     * <p>
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link ConfigConfigItemSet }
     * 
     * 
     */
    public List<ConfigConfigItemSet> getConfigConfigItemSet() {
        if (this.configConfigItemSet == null) {
            this.configConfigItemSet = new ArrayList<ConfigConfigItemSet>();
        }
