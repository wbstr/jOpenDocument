...
public class TableDependences {
     ...
     * why there is not a <CODE>set</CODE> method for the tableDependence property.
     * 
     * <p>
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link TableDependence }
     * 
     * 
     */
    public List<TableDependence> getTableDependence() {
        if (this.tableDependence == null) {
            this.tableDependence = new ArrayList<TableDependence>();
        }
