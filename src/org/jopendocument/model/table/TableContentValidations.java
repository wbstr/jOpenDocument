...
public class TableContentValidations {
     ...
     * why there is not a <CODE>set</CODE> method for the tableContentValidation property.
     * 
     * <p>
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link TableContentValidation }
     * 
     * 
     */
    public List<TableContentValidation> getTableContentValidation() {
        if (this.tableContentValidation == null) {
            this.tableContentValidation = new ArrayList<TableContentValidation>();
        }
