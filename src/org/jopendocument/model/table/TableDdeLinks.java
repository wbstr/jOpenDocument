...
public class TableDdeLinks {
     ...
     * why there is not a <CODE>set</CODE> method for the tableDdeLink property.
     * 
     * <p>
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link TableDdeLink }
     * 
     * 
     */
    public List<TableDdeLink> getTableDdeLink() {
        if (this.tableDdeLink == null) {
            this.tableDdeLink = new ArrayList<TableDdeLink>();
        }
