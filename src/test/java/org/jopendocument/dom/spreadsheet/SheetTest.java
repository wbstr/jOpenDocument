...
public class SheetTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        // when possible use fods
        // as of LO 3.5.5.3, spurious style:text-position="" are everywhere
        this.realSheet = new ODPackage(this.getClass().getResourceAsStream("test.ods")).getSpreadSheet().getSheet(0);
    }
    ...
    private final ParagraphStyle getFirstPStyle(final Cell<TextDocument> cell) {
    ...
    public void testRemoveRow() throws Exception {
        final Sheet sheet = this.realSheet.getSpreadSheet().getSheet("remove");
        ...
        // before
        {
            ...
            assertEquals(0, level1Group.getFirst());
            assertEquals(7, level1Group.getSize());
        ...
        // after
        {
            ...
            final TableGroup level1Group = level1Groups.get(0);
            assertEquals(0, level1Group.getFirst());
            assertEquals(3, level1Group.getSize());
    ...
    public void testMerge() throws IOException {
        {
            final Table<?> t = this.realSheet.getSpreadSheet().getSheet(2);
    ...
    public void testResolve() {
        ...
        for (final Range range : new Range[] { sansSheetRange, oneSheetRange, twoSheetsRange, spanSheetsRange }) {
            ...
            assertEquals(Sheet.resolve("AA34"), range.getEndPoint());
        }
    ...
    public void testDuplicateRows() throws Exception {
        ...
        final Sheet sheet2 = this.realSheet.getSpreadSheet().getSheet("end'Cell & Address");
    ...
    public void testGroups() throws Exception {
        final Sheet sheet = this.realSheet.getSpreadSheet().getSheet("Groups");
