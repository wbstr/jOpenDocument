...
public class TextUserFieldDecls {
     ...
     * why there is not a <CODE>set</CODE> method for the textUserFieldDecl property.
     * 
     * <p>
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link TextUserFieldDecl }
     * 
     * 
     */
    public List<TextUserFieldDecl> getTextUserFieldDecl() {
        if (this.textUserFieldDecl == null) {
            this.textUserFieldDecl = new ArrayList<TextUserFieldDecl>();
        }
