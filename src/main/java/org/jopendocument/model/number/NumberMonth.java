...
public class NumberMonth {
    ...
    public String getNumberTextual() {
        if (this.numberTextual == null) {
            return "false";
        } else {
            return this.numberTextual;
        }
    }
     ...
     * 
     */
    public void setNumberCalendar(final String value) {
        this.numberCalendar = value;
    }
     ...
     * 
     */
    public void setNumberTextual(final String value) {
        this.numberTextual = value;
    }
