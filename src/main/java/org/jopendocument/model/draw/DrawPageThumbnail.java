 ...
 * 
 */
public class DrawPageThumbnail {

    protected String drawId;
    protected String drawLayer;
    protected String drawPageNumber;
     ...
     * 
     */
    public String getDrawPageNumber() {
        return this.drawPageNumber;
    }
     ...
     * 
     */
    public void setDrawPageNumber(final String value) {
        this.drawPageNumber = value;
    }
