...
public class TableTableRows {
     ...
     * why there is not a <CODE>set</CODE> method for the tableTableRowOrTableTableRowGroup
     * property.
     * 
     * <p>
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link TableTableRow }
     * {@link TableTableRowGroup }
     * 
     * 
     */
    public List<Object> getTableTableRowOrTableTableRowGroup() {
        if (this.tableTableRowOrTableTableRowGroup == null) {
            this.tableTableRowOrTableTableRowGroup = new ArrayList<Object>();
        }
