 ...
 * 
 */
public class TableTableHeaderColumns {
     ...
     * why there is not a <CODE>set</CODE> method for the tableTableColumnOrTableTableColumnGroup
     * property.
     * 
     * <p>
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link TableTableColumn }
    ...
    public List<Object> getTableTableColumnOrTableTableColumnGroup() {
        if (this.tableTableColumnOrTableTableColumnGroup == null) {
            this.tableTableColumnOrTableTableColumnGroup = new ArrayList<Object>();
        }
