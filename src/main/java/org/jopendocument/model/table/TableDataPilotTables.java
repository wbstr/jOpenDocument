...
public class TableDataPilotTables {
     ...
     * why there is not a <CODE>set</CODE> method for the tableDataPilotTable property.
     * 
     * <p>
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link TableDataPilotTable }
     * 
     * 
     */
    public List<TableDataPilotTable> getTableDataPilotTable() {
        if (this.tableDataPilotTable == null) {
            this.tableDataPilotTable = new ArrayList<TableDataPilotTable>();
        }
