...
public class TableLabelRanges {
     ...
     * why there is not a <CODE>set</CODE> method for the tableLabelRange property.
     * 
     * <p>
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link TableLabelRange }
     * 
     * 
     */
    public List<TableLabelRange> getTableLabelRange() {
        if (this.tableLabelRange == null) {
            this.tableLabelRange = new ArrayList<TableLabelRange>();
        }
