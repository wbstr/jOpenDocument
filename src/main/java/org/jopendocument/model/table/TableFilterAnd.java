...
public class TableFilterAnd {
     ...
     * why there is not a <CODE>set</CODE> method for the tableFilterOrOrTableFilterCondition
     * property.
     * 
     * <p>
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link TableFilterOr }
    ...
    public List<Object> getTableFilterOrOrTableFilterCondition() {
        if (this.tableFilterOrOrTableFilterCondition == null) {
            this.tableFilterOrOrTableFilterCondition = new ArrayList<Object>();
        }
